...
export default function JobEditPage({
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      ...
      (snapshot) => {
        if (snapshot.exists()) {
          const data = snapshot.data() as Omit<JobDocument, "id">;
  ...
  const onSubmit = async (data: JobFormInput) => {
    ...
    const payload: Partial<JobDocument> = {
      title: data.title,
      organisation: data.organisation,
      category: data.category,
      deadline: data.deadline,
    ...
    try {
      ...
      toast.success("চাকরির তথ্য সফলভাবে আপডেট হয়েছে ✓");
      router.push(`/job/${id}`);
    } catch {
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="flex-1 max-w-md mx-auto pt-16 px-4 text-center">
          <p className="text-gray-500">
            এই চাকরির ডেটা পাওয়া যায়নি অথবা আপনি এই চাকরির মালিক নন।
          </p>
          <Button
            variant="primary"
            fullWidth
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div className="text-left">
              <h1 className="text-2xl font-black text-gray-900 font-sans tracking-tight">
                চাকরির তথ্য সম্পাদনা করুন
              </h1>
              <p className="text-xs text-gray-500 font-sans mt-0.5">
                বিজ্ঞপ্তির বর্তমান তথ্য আপডেট করুন।
              </p>
            </div>
          </div>
            ...
            {categoryValue === "govt" && (
              <div className="bg-white border border-blue-100 shadow-xs rounded-2xl p-6 text-left space-y-4">
                ...
                <p className="text-xs text-gray-500 font-sans leading-relaxed">
                  সরকারি আবেদনের পোর্টালে লগইন করার জন্য ইউজারনেম ও পাসওয়ার্ড
                  সংরক্ষণ করুন।
                </p>
